...
$(document).ready(function () {
    var ser = new WebApplication_WorkFlow01.WebService.AutoComplete();
    var ser1 = new WebApplication_WorkFlow01.WebService.WebService1();
    ser.GetMatterName(
    function (result) {
        availableTags = result;
        $("#Text1").autocomplete({ source: availableTags });
    }
    );
    $("#Button1").click(function () {
        var matterName = $("input[id='Text1']").val();
        if (matterName == "") {
            return;
        }
